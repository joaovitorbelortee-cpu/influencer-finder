    ...
    <Card className="border-0 shadow-2xl">
      ...
      <CardContent>
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-xs text-[#6C63FF] hover:underline">Esqueci minha senha</Link>
            </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-4">
          Não tem conta?{" "}
          <Link href="/signup" className="text-[#6C63FF] hover:underline font-medium">Criar conta grátis</Link>
        </p>
      </CardContent>
    </Card>
  )
